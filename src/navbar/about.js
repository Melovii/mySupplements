...
function createAboutContent() {
    ...
    const qualityLi = createElement('li', 'Quality: We believe that what you put into your body matters. That\'s why we source only the best ingredients and ensure that every batch of our supplements meets the highest standards of quality and safety.');
    const transparencyLi = createElement('li', 'Transparency: You deserve to know exactly what you\'re taking. We provide clear, detailed information about each of our products, including the sourcing of our ingredients and the science behind them.');
    const innovationLi = createElement('li', 'Innovation: The world of health and fitness is constantly evolving, and so are we. We stay at the forefront of research and development to bring you the latest in supplement science.');

    ulTitles.appendChild(qualityLi);
    ulTitles.appendChild(transparencyLi);
    ulTitles.appendChild(innovationLi);
